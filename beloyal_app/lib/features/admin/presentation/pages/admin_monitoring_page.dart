  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        .animate(delay: (index * 50).ms + 200.ms)
...
class _ApiHealthList extends StatelessWidget {
  const _ApiHealthList();

  @override
  Widget build(BuildContext context) {
    final endpoints = [
      ('/api/besahub/admin/platform/users', 'GET', true, 'Users overview'),
      ('/api/besahub/admin/businesses', 'GET', true, 'Business list'),
      (
        '/api/besahub/admin/businesses/{id}/suspend',
        'PATCH',
        true,
        'Lifecycle management',
      ),
      (
        '/api/besahub/customer/profile',
        'POST',
        true,
...
class _ApiRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final methodColor = switch (method) {
      ...
      'POST' => AppColors.accent,
      'PATCH' => AppColors.warning,
    ...
    return Row(
      children: [
        ...
        .animate(delay: (index * 50).ms + 250.ms)
        .fadeIn(duration: 300.ms)
