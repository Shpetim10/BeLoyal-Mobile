class PointTransactionBusinessListViewDto {
  PointTransactionBusinessListViewDto({
    required this.id,
  ...
  factory PointTransactionBusinessListViewDto.fromJson(Map<String, dynamic> json) {
    ...
    return PointTransactionBusinessListViewDto(
