...
enum _TxFilter { all, earn, redeem, couponPurchase, expired, refunded, adjustment }
...
class _CustomerOrdersTabState extends State<CustomerOrdersTab> {
  ...
  List<MockTransaction> get _filtered {
    final all = [...CustomerMockData.transactions]
  ...
  Widget build(BuildContext context) {
    ...
    final totalEarned = _filtered
        .where((t) => t.type == 'EARN')
        .fold(0, (s, t) => s + t.points);
    final totalSpent = _filtered
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 10),
              _SummaryPill(label: 'Total', value: '${txs.length}', color: AppColors.primary),
            ],
          ),
        ),
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? color.withValues(alpha: 0.15) : AppColors.cardDark,
          ...
          child: txs.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.receipt_outlined, size: 52, color: AppColors.textMutedDark.withValues(alpha: 0.3)),
                      const SizedBox(height: 16),
                      Text('No transactions', style: AppTypography.dmSans(fontSize: 14, color: AppColors.textMutedDark)),
                      const SizedBox(height: 6),
                      Text('Try a different filter', style: AppTypography.dmSans(fontSize: 12, color: AppColors.textMutedDark.withValues(alpha: 0.6))),
                    ],
                  ),
                )
              : ListView(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(_typeLabel, style: AppTypography.dmSans(fontSize: 9, fontWeight: FontWeight.w700, color: _typeColor)),
                        ],
                      ),
                    ),
                    const SizedBox(width: 8),
          ...
          Column(
            ...
            children: [
              Text(
                ...
                style: AppTypography.dmMono(fontSize: 17, fontWeight: FontWeight.w700, color: _typeColor),
              ),
