...
class EarningRuleSetupPage extends ConsumerStatefulWidget {
  const EarningRuleSetupPage({super.key, required this.businessId});

  final int businessId;

  @override
  ConsumerState<EarningRuleSetupPage> createState() =>
      _EarningRuleSetupPageState();
}

class _EarningRuleSetupPageState extends ConsumerState<EarningRuleSetupPage> {
        ...
        SnackBar(
          content: const Row(
            children: [
              ...
              SizedBox(width: 10),
              Expanded(child: Text('Earning rule saved')),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Set up earning rule'),
